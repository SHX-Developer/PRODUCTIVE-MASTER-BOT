...
def display_monday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на понедельник: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_monday_tasks_2(message):
...
def display_tuesday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на вторник: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_tuesday_tasks_2(message):
...
def display_wednesday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на среду: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_wednesday_tasks_2(message):
...
def display_thursday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на четверг: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_thursday_tasks_2(message):
...
def display_friday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на пятницу: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_friday_tasks_2(message):
...
def display_saturday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на субботу: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_saturday_tasks_2(message):
...
def display_sunday_tasks_1(message):
    ...
    bot.send_message(message.chat.id, "<b> Ваши задачи на воскресенье: </b>", parse_mode="html", reply_markup=tasks_inline)


def display_sunday_tasks_2(message):
